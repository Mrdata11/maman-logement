...
export function HeroBanner({ alwaysVisible = false }: HeroBannerProps) {
  const [dismissed, setDismissed] = useState(!alwaysVisible); // default hidden to avoid flash
  ...
  return (
    <div className="mb-8 rounded-2xl bg-[var(--card-bg)] border border-[var(--border-color)] shadow-sm overflow-hidden">
      <div className="px-6 py-8 sm:px-8 sm:py-10">
        ...
        <p className="text-[var(--muted)] text-base sm:text-lg mb-8 leading-relaxed max-w-2xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
          ...
          >
            <div className="w-10 h-10 rounded-lg flex items-center justify-center shrink-0 mt-0.5" style={{ backgroundColor: "color-mix(in srgb, var(--primary) 15%, transparent)" }}>
          ...
          >
            <div className="w-10 h-10 rounded-lg flex items-center justify-center shrink-0 mt-0.5" style={{ backgroundColor: "color-mix(in srgb, var(--accent) 15%, transparent)" }}>
