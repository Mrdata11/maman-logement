    ...
    <div className="mt-6 print:mt-8">
      {!isOpen ? (
        <button
          ...
          className="w-full p-4 bg-gradient-to-r from-indigo-50 to-blue-50 dark:from-indigo-950/30 dark:to-blue-950/30 border border-indigo-200 dark:border-indigo-800 rounded-lg text-left hover:shadow-md transition-shadow print:hidden"
        >
        ...
        <div className="border border-indigo-200 dark:border-indigo-800 rounded-lg overflow-hidden">
          <div className="flex items-center justify-between px-4 py-3 bg-indigo-50 dark:bg-indigo-950/30 border-b border-indigo-200 dark:border-indigo-800">
            ...
            <div className="flex items-center gap-2">
              {report && (
                <button
                  ...
                  className="text-sm px-3 py-1 border border-indigo-300 dark:border-indigo-700 text-indigo-700 dark:text-indigo-300 rounded-md hover:bg-indigo-100 dark:hover:bg-indigo-900/30 print:hidden"
                >
                  Imprimer
                </button>
              )}
              <button
                ...
                className="text-indigo-400 hover:text-indigo-600 dark:hover:text-indigo-200 print:hidden"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="p-4 bg-white dark:bg-slate-800">
            ...
            {report && (
              <div className="prose prose-sm dark:prose-invert max-w-none">
                ...
                <div className="mt-4 pt-4 border-t border-gray-200 dark:border-slate-700 flex gap-2 print:hidden">
                  <button
                    onClick={handleGenerate}
                    className="text-sm px-4 py-1.5 border border-indigo-300 dark:border-indigo-700 text-indigo-700 dark:text-indigo-300 rounded-md hover:bg-indigo-50 dark:hover:bg-indigo-900/30"
                  >
                    Regenerer
                  </button>
                </div>
