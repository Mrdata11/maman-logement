...
export function AppModeToggle() {
  ...
  return (
    <div className="flex bg-[var(--surface)] p-1 rounded-xl gap-0.5">
      <Link
        href="/habitats"
        className={`px-3 sm:px-5 py-2 rounded-lg text-sm font-medium transition-colors inline-flex items-center gap-1.5 ${
